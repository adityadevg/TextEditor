...
public class ExampleAgent extends BackupAgent {
    ...
    public void onBackup(ParcelFileDescriptor oldState, BackupDataOutput data,
        ...
        synchronized (NewDoc.sDataLock) {
            ...
            meducation = file.readInt();
            mandroid = file.readBoolean();
            mphp = file.readBoolean();
        }
        ...
        if (doBackup) {
            ...
            outWriter.writeInt(meducation);
            outWriter.writeBoolean(mandroid);
            outWriter.writeBoolean(mphp);
    ...
    boolean compareStateFile(ParcelFileDescriptor oldState) {
        ...
        try {
            ...
            int lasteducation = in.readInt();
            boolean lastandroid = in.readBoolean();
            boolean lastphp = in.readBoolean();

            return (lasteducation != meducation)
                    || (lastphp != mphp)
                    || (lastandroid != mandroid);
        }
        catch (IOException e) {
    ...
    void writeStateFile(ParcelFileDescriptor stateFile) throws IOException {
        ...
        out.writeInt(meducation);
        out.writeBoolean(mandroid);
        out.writeBoolean(mphp);
    }
    ...
    public void onRestore(BackupDataInput data, int appVersionCode,
        ...
        while (data.readNextHeader()) {
            ...
            if (APP_DATA_KEY.equals(key)) {
                ...
                meducation = in.readInt();
                mandroid = in.readBoolean();
                mphp = in.readBoolean();
                ...
                synchronized (NewDoc.sDataLock) {
                    ...
                    file.setLength(0L);
                    file.writeInt(meducation);
                    file.writeBoolean(mandroid);
                    file.writeBoolean(mphp);
                }
            } else {
